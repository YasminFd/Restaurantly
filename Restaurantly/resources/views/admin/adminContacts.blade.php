...
<body>
    ...
    <div class="flex justify-end m-2 p-2 ">
        <a href="/admin-contacts/create" class=" px-4 py-2 bg-indigo-500 hover:bg-indigo-800 rounded-lg text-white ">add branch</a>
    </div>
        ...
        <table class=" text-sm text-left text-gray-500 dark:text-gray-400" style=" table-layout: fixed;">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="px-6 py-4">
                        <a href="/admin-contacts/{{ $branch['id' ]}}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline" >edit</a>
                    </td>
                    <td class="px-6 py-4">
                        <form  class="font-medium text-blue-600 dark:text-blue-500 hover:underline" 
                         action="/admin-contacts/ {{$branch['id'] }}"
                          method="POST"
